...
export interface ApiAgentAgent extends Schema.CollectionType {
  ...
  attributes: {
    ...
    conges: Attribute.Relation<
      'api::agent.agent',
      'oneToMany',
      'api::conge.conge'
    >;
    type_contrat: Attribute.String;
    planning_conges: Attribute.Relation<
      'api::agent.agent',
      'oneToMany',
...
export interface ApiCongeConge extends Schema.CollectionType {
  ...
  attributes: {
    ...
    date_fin: Attribute.Date;
    statut: Attribute.Enumeration<['pending', 'refused', 'validated']>;
...
export interface ApiPlanningCongePlanningConge extends Schema.CollectionType {
  collectionName: 'planning_conges';
  info: {
    singularName: 'planning-conge';
    pluralName: 'planning-conges';
    displayName: 'planning-conge';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    title: Attribute.String;
    exercices: Attribute.String;
    jours_prevus: Attribute.Integer;
    agent: Attribute.Relation<
      'api::planning-conge.planning-conge',
      'manyToOne',
      'api::agent.agent'
